# Attribution: This is an edited copy of a Bedrock Samples file located at https://github.com/awslabs/amazon-bedrock-agent-samples/blob/main/examples/amazon-bedrock-multi-agent-collaboration/energy_efficiency_management_agent/utils/bedrock_agent_helper.py
...
class AgentsForAmazonBedrock:
    ...
    def add_action_group_with_lambda(
        ...
        # Alter this to include API Schema if passed in ALTERE
